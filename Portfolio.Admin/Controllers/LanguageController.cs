...
namespace Portfolio.Admin.Controllers
{
    ...
    {
        private readonly IBaseService< Language> _service;

        public LanguageController(IBaseService<Language> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Update(Language lang)
        {
